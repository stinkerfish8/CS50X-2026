# Cat Matrix Experiment

An extra terminal-based project featuring a custom C program.
...
## Demo
![Cat Matrix Demo](cat_matrix.gif)

## Tools to make the demo
* Install asciinema: pip install asciinema
* Start recording: asciinema rec file_name.cast
* Type exit to finish the recording
* Upload the file to: https://dstein64.github.io/gifcast/
